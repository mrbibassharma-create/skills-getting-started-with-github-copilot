...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["nathan@mergington.edu", "leah@mergington.edu"]
    },
    "Soccer Club": {
    ...
    "Science Olympiad": {
        "description": "Compete in science challenges and build STEM projects",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    #Validatestudent is not already signed up
